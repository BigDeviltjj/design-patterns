...
public:
  ...
  void show() {
    cout<<"__CurrentConditionBoard__"<<endl;
...
public:
  ...
  void show() {
    cout<<"_______StatisticBoard________"<<endl;
    cout<<"lowest temperature: "<<m_mint<<endl;
    cout<<"highest temperautre: "<<m_maxt<<endl;
...
int main(int argc, char *argv[]) {
  ...
  wdata->SensorDataChange(12.2, 18.2, 101);
  wdata->SensorDataChange(33.2, 3422, 321);
  wdata->SensorDataChange(1, 2, 3);
